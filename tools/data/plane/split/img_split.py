...
def add_parser(parser):
    ...
    parser.add_argument(
        '--base-json',
        type=str,
        default="/data5/laiping/tianzhibei/code/Large-Selective-Kernel-Network/tools/data/plane/split/split_configs/ss_test.json",
...
def parse_args():
    ...
    add_parser(parser)
    # print(parser)
    # parser.base_json = "/data5/laiping/tianzhibei/code/Large-Selective-Kernel-Network/tools/data/plane/split/split_configs/ss_test.json"
...
def main(input_path,save_path):
    ...
    json_file = '/data5/laiping/tianzhibei/code/Large-Selective-Kernel-Network/tools/data/plane/split/split_configs/ss_test.json'
    args = parse_json_file(json_file)

    # default_filename = "/data5/laiping/tianzhibei/code/Large-Selective-Kernel-Network/tools/data/plane/split/split_configs/ss_test.json"
    # args = argparse.Namespace(filename=default_filename)
    # args = parse_args()
    # print(type(args))

    args.img_dirs = [f"{input_path}"]
