...
def single_split(arguments, sizes, gaps, img_rate_thr, iof_thr, no_padding,
    ...
    patch_infos = crop_and_save_img(info, windows, window_anns, img_dir,no_padding, padding_value, save_dir,anno_dir, img_ext)
    assert patch_infos
...
def main(input_path,save_path):
    ...
    json_file = '/mnt/hdd1/xueyijun/Vicy/object_detection/tools/data/fair/ss_test.json'
    ...
    check_path(save_imgs)
    check_path(save_files)
    # 检查文件夹是否存在
